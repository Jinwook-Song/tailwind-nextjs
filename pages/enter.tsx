    ...
    <div className='mt-16 px-4'>
      ...
      <div className='mt-8'>
        <div className='flex flex-col items-center'>
          ...
          <div className='mt-4 border-b w-full grid grid-cols-2'>
            <button
              className={cls(
                'pb-4 font-medium',
                method === 'email'
        ...
        <form className='flex flex-col mt-4'>
          ...
          <button className='mt-4 bg-orange-500 hover:bg-orange-600 text-white px-3 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 focus:outline-none'>
        ...
        <div className='mt-6'>
          ...
          <div className='grid grid-cols-2 gap-6 mt-2'>
            <button className='flex justify-center items-center px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50'>
              <svg
                className='w-5 h-5'
                aria-hidden='true'
                fill='currentColor'
