...
const Profile: NextPage = () => {
  return (
    <Layout title='나의 마켓' hasTabBar>
      <div className='px-4'>
        <div className='flex items-center space-x-3'>
          <div className='w-16 aspect-square bg-slate-300 rounded-full' />
        ...
        <div className='mt-10 flex justify-around '>
          <div className='flex flex-col items-center'>
            <div className='w-14 aspect-square text-white bg-orange-500 rounded-full flex justify-center items-center'>
              <svg
                className='w-6 h-6'
                fill='none'
                stroke='currentColor'
